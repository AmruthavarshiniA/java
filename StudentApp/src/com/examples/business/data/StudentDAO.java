...
private Connection conn;
    ...
    public StudentDAO()
    {
      ...
      public ArrayList fetchStudentData()
      {
    	  ...
    	  try
    	  {
    		  rs = stmt.executeQuery("select student_roll_no,student_name,student_gender,student_email,student_city,maths_marks,physics_marks,chemistry_marks,computer_science_marks from student_master");
    		  list = new ArrayList();
    		  while(rs.next())
    		  {
    			  stud = new Student();
    			  ...
    			  stud.setEmail(rs.getString("student_email"));
    			  stud.setCity(rs.getString("student_city"));
